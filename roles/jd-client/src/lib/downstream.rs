...
impl DownstreamMiningNode {
    ...
    pub async fn next(self_mutex: &Arc<Mutex<Self>>, mut incoming: StdFrame) {
        ...
        info!("call handle_message_mining");
    ...
    pub async fn send(
        ...
        info!("either_frame:{:?}",either_frame);
    ...
    > for DownstreamMiningNode
{
    ...
    fn handle_open_extended_mining_channel(
        ...
        info!("start handle_open_extended_mining_channel");
    ...
    fn handle_submit_shares_extended(
        ...
        info!("line:{:?} start handle_submit_shares_extended",line!());
        match self
            .status
            .get_channel()
