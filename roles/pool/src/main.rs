...
lazy_static! {
    static ref IF_DECRYPTION_PASSWORD_SET: Mutex<bool> = Mutex::new(false);
    static ref DECRYPTION_PASSWORD: Mutex<String> = Mutex::new(String::new());
}

fn get_decryption_password() -> Result<String, Box<dyn Error>> {
